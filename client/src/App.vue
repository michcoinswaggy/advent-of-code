<template>
    <div id="app">
        <div id="nav">
            ...
            <br>
            <router-link style="color: green" to="/dayone">Day One</router-link> |
            <router-link style="color: green" to="/daytwo">Day Two</router-link> |
            <router-link style="color: green" to="/daythree">Day Three</router-link> |
